(function () {
  const translatedPages = new Set([
    ...
    "collection-en.html",
    "garage-en.html",
    "garage-carte-en.html",
    "garage-cuisine-en.html",
    "garage-chefs-en.html",
    "garage-temps-forts-en.html",
    "garage-reservation-en.html",
    "horaires-en.html",
    "tickets-en.html",
  ...
  const englishHrefMap = new Map([
    ...
    ["garage-carte.html", "garage-carte-en.html"],
    ["garage-cuisine.html", "garage-cuisine-en.html"],
  ...
  const patchEnglishChrome = () => {
    ...
    const anchorLabels = new Map([
      ...
      ["garage-carte-en.html", { label: "Menu", subtitle: "Signature menu & desserts" }],
      ["garage-cuisine-en.html", { label: "Open kitchen", subtitle: "Culinary studio" }],
      ["garage-chefs-en.html", { label: "The chefs", subtitle: "Vision & transmission" }],
      ["garage-temps-forts-en.html", { label: "Highlights", subtitle: "Ramadan, cocktails, news" }],
      ["garage-reservation-en.html", { label: "Book a table", subtitle: "Lunch, dinner, brunch" }],
